...
### Objective
To create and implement a secure, compliant, and automated **"Single-Command"** environment for a high-availability Node.js application.

### Business Context
A rapidly growing SaaS startup is looking to shift from manual **"Click-Ops"** to automated **"GitOps"** to meet security audit requirements (**DORA 2026/GDPR**) and minimize deployment risks.

### Key Deliverables
* **Modular Terraform Blueprints:** (VPC, RDS, Beanstalk).
